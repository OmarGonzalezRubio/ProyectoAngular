...
module.exports = function(grunt){
		...
		jshint: {
			...
			all: {
				src: [
					'Gruntfile.js',
					'app/scripts/{,*/}*.js' 
					//podemos decir que no se ejecute dicho archivo con negacion !
				]
			}
		},
		useminPrepare: {
            ...
            generated: {
				options: {
					output: {
						...
						beautify: false	// imprimir human-readable code
					},
					compress: {
	...
	//watch hilo que vigila a que hora se ejecuta el archivo
